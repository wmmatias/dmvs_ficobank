...
?>                            </tbody>
                  ...
                  <h6>Return Documents</h6>
                  <?=$this->session->flashdata('input_errors');?>
				  <div>
					<form action="/documents/return_validation" method="post">
                    	<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?= $this->security->get_csrf_hash();?>" />
						<div class="row">
							<div class="col-md">
								<div class="col-md input-group input-group-outline my-1 focused is-focused">
                                    <label class="form-label">Location</label>
									<input type="text" name="location" class="form-control" value="return" readonly>
								</div>
							</div>
							<div class="col-md">
							...
							<div class="col-md">
								<div class="col-md-4 input-group input-group-outline my-1 focused is-focused">
									...
									<input type="text" name="status" class="form-control" value="return" readonly>
								</div>
							</div>
							<div class="col-md">
								<div class="col-md-4 input-group input-group-outline my-1 focused is-focused">
